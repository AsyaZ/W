...
namespace LaboratoryWork1
{
    ...
    public partial class MainWindow : Window
    {
        ...
        //5. Дан массив из K чисел.Замените элементы ghfhbjмассива таким образом, чтобы элементы составляли со своими соседями упорядоченную последовательность.Направления последовательности могут меняться.
